...
public class EmpDimissionController {
    ...
    //    新增离职
    @PostMapping("/inserEmpDimission")
    public Integer inserEmpDimission(@RequestBody EmpDimission empDimission){
        return empDimissionService.inserEmpDimission(empDimission);
    }
